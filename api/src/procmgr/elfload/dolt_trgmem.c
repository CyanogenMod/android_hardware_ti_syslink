...
/* memory allocator.  The DOLT version of the dynamic loader will manage     */
/* target memory from a massive data object called "trg_mem_pool".  This     */
/* memory manager is derived from the C6x RTS version of malloc()/free()     */
/* and from the linker allocator's model of target memory.                   */
/*                                                                           */
/*---------------------------------------------------------------------------*/
/*                                                                           */
