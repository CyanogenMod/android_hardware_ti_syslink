...
/* dolt_client.c                                                             */
/*                                                                           */
/* DOLT implementation of client functions required by dynamic loader API.   */
/* Please see list of client-required API functions in dload_api.h.          */
/*                                                                           */
/* DOLT is expected to run on the DSP.  It uses C6x RTS functions for file   */
...
#include <stdlib.h>
#include <string.h>
#include "dolt_debug.h"
#include "dolt_dsbt.h"
#include "dolt_trgmem.h"
...
/*****************************************************************************/
/* DOLT-Specific hack to facilitate target memory allocation.                */
/*****************************************************************************/
/*****************************************************************************/
